...
namespace GrpcService
{
    ...
    public class BankingService : AppCallback.AppCallbackBase
    {
        ...
        public override async Task<InvokeResponse> OnInvoke(InvokeRequest request, ServerCallContext context)
        {
            ...
            {
                case "getaccount":                
                    var input = request.Data.Unpack<GrpcService.Generated.GetAccountRequest>();
                    var output = await GetAccount(input, context);
                    response.Data = Any.Pack(output);
                    break;
                case "deposit":
                case "withdraw":
                    var transaction = request.Data.Unpack<GrpcService.Generated.Transaction>();
        ...
        public override async Task<TopicEventResponse> OnTopicEvent(TopicEventRequest request, ServerCallContext context)
        {
            if (request.PubsubName == "pubsub")
            {
                ...
                var transaction = new GrpcService.Generated.Transaction() { Id = input.Id, Amount = (int)input.Amount, };
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public async Task<GrpcService.Generated.Account> GetAccount(GetAccountRequest input, ServerCallContext context)
        {
            var state = await _daprClient.GetStateEntryAsync<Models.Account>(StoreName, input.Id);
            return new GrpcService.Generated.Account() { Id = state.Value.Id, Balance = (int)state.Value.Balance, }; 
        }
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public async Task<GrpcService.Generated.Account> Deposit(GrpcService.Generated.Transaction transaction, ServerCallContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public async Task<GrpcService.Generated.Account> Withdraw(GrpcService.Generated.Transaction transaction, ServerCallContext context)
        {
